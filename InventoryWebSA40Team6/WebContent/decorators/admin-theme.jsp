							...
							<ul class="nav navbar-nav">
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="/InventoryWebSA40Team6/Admin/inventorystock">Maintain Product</a></li>
										<li class="divider"></li>
										<li><a href="/InventoryWebSA40Team6/Admin/LoadPrdServlet">Add Product</a></li>
								...
								<li class="dropdown"><a href="order.jsp"
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="/InventoryWebSA40Team6/Admin/test">Make Order</a></li>
										<li class="divider"></li>
								...
								<li class="dropdown"><a href="order.jsp"
									...
									<ul class="dropdown-menu" role="menu">
										<li><a href="/InventoryWebSA40Team6/Admin/inventorystock">Maintain Inventory</a></li>
									</ul></li>
							</ul>
