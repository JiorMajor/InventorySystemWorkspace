	...
	<div class="container main">
		<div class="row">
			...
			<div class="col-md-8 col-md-push-4 ">
				<form action="/InventoryWebSA40Team6/Admin/AddPrdServlet" method="post">


					<c:if test="${origin==\"true\"}">
					<h4 class="success" style="width:57%"><span class="glyphicon glyphicon-ok" style="margin-right:10px;"></span>Product data is successfully saved!</h3>
					</c:if>
				...
				<div class="form-group row">
					...
					<div class="col-md-4">
						<input type="text" class="form-control" name="price" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" required value=""/>
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" name="total" required value="" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/>
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" name="reqty" required value="" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return true"/>
