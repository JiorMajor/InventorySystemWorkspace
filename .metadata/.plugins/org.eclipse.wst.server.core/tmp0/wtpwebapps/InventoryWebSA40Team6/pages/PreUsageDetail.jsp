...
<body>
	...
	<div class="container main">
		<div class="row">
			...
			<form action="/InventoryWebSA40Team6/RecordUsageServlet" method=post>
				<c:if test="${flag==\"true\"}">
					<h4 class="success">
				...
				<table 
					class="table table-responsive table-hover display">
					<thead>
						<tr>
							<th>Part No</th>
							<th>Name</th>
				...
				<c:url var="updurl" scope="page" value="/LoadUsageServlet">
				</c:url>
